 ...
 */
            ...
            /**
            *  AuthenticateCDClient bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AuthenticateCDClient
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":authenticateCDClient",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "authenticateCDClient",
    ...
    public static class Factory{
        ...
        */
        public static AuthenticateCDClient parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AuthenticateCDClient object =
                new AuthenticateCDClient();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"authenticateCDClient".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AuthenticateCDClient)org.example.www.jmtbank.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
