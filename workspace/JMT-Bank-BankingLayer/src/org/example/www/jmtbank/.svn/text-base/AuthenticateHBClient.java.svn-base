 ...
 */
            ...
            /**
            *  AuthenticateHBClient bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AuthenticateHBClient
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":authenticateHBClient",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "authenticateHBClient",
    ...
    public static class Factory{
        ...
        */
        public static AuthenticateHBClient parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AuthenticateHBClient object =
                new AuthenticateHBClient();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"authenticateHBClient".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AuthenticateHBClient)org.example.www.jmtbank.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
